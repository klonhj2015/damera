...
from damera.common import safe_utils
from damera.i18n import _
from damera.i18n import _LE
...
def wrap_controller_exception(func, func_server_error, func_client_error):
    ...
    def wrapped(*args, **kw):
        try:
            ...
            if isinstance(excp, DameraException):
...
class DameraException(Exception):
    ...
    def __init__(self, message=None, **kwargs):
        ...
        super(DameraException, self).__init__(self.message)
...
#
#
class AuthorizationFailure(DameraException):
